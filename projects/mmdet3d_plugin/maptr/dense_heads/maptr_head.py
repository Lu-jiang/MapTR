...
class MapTRHead(DETRHead):
    ...
    def loss(self,
        ...
        gt_bboxes_list = [
            gt_bboxes.bbox.to(device) for gt_bboxes in gt_vecs_list]    # len=4, each=torch.Size([num_ins, 4])
        gt_pts_list = [
        ...
        if self.gt_shift_pts_pattern == 'v0':
            ...
            gt_shifts_pts_list = [
                gt_bboxes.shift_fixed_num_sampled_points_v2.to(device) for gt_bboxes in gt_vecs_list]   # len=4, each=torch.Size([num_ins, num_shift, 20, 2])
